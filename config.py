...
class Configuration:
    def __init__(self, *args, **kwargs):
        ...
        self.save_pop_folder = (
            "pop_data/"  # folder to write population timestep data to
        )
        self.endif_no_infections = (
